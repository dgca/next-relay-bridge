        ...
        function preloadQuery(query, variables) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            loadedQuery = loadQuery(relayEnvironment, query, variables);
                            return [4 /*yield*/, awaitQuery(loadedQuery)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, makeRawQuery(query, variables, loadedQuery)];
                    }
                });
            });
        }
        var relayEnvironment, initialProps, serializedStore;
