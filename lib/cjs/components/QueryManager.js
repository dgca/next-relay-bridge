...
var QueryManager = /** @class */ (function (_super) {
    ...
    QueryManager.getDerivedStateFromProps = function (props, state) {
        ...
        return rawRelayQueryEntries.reduce(function (acc, _a) {
            ...
            var loadedQuery = (0, isServer_1.default)()
                ? result
                : (0, react_relay_1.loadQuery)(props.getClientEnvironment((_c = (_b = props.pageProps.__nextRelayBridgeProps__) === null || _b === void 0 ? void 0 : _b.initialStore) !== null && _c !== void 0 ? _c : {}), query, variables);
            acc[key] = loadedQuery;
            return acc;
        }, {});
    };
    ...
    QueryManager.prototype.getRelayEnvironment = function () {
        ...
        if (!(0, isServer_1.default)()) {
            return this.props.getClientEnvironment(initialStore);
        }
        return ((_d = (_c = this.props.pageProps.__nextRelayBridgeProps__) === null || _c === void 0 ? void 0 : _c.relayEnvironment) !== null && _d !== void 0 ? _d : this.props.getServerEnvironment());
    };
    QueryManager.prototype.render = function () {
        var _a = this.props, AppComponent = _a.AppComponent, pageProps = _a.pageProps, getServerEnvironment = _a.getServerEnvironment, getClientEnvironment = _a.getClientEnvironment, relayEnvironment = _a.relayEnvironment, rest = __rest(_a, ["AppComponent", "pageProps", "getServerEnvironment", "getClientEnvironment", "relayEnvironment"]);
