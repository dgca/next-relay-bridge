...
function getClientInitialProps(_a) {
    var _b;
    var context = _a.context, userGetInitialProps = _a.userGetInitialProps;
    return __awaiter(this, void 0, void 0, function () {
        function preloadQuery(query, variables) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, makeRawQuery_1.default)(query, variables)];
                });
            });
        }
        var initialProps, destination;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, userGetInitialProps({
                        context: context,
                ...
                case 1:
                    ...
                    if ((_b = initialProps.redirect) === null || _b === void 0 ? void 0 : _b.destination) {
                        ...
                        (0, redirect_1.default)(context, destination);
                        return [2 /*return*/, {}];
                    }
