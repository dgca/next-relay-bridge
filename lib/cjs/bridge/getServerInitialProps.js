...
function getServerInitialProps(_a) {
    var _b;
        ...
        function preloadQuery(query, variables) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            loadedQuery = (0, react_relay_1.loadQuery)(relayEnvironment, query, variables);
                            return [4 /*yield*/, awaitQuery(loadedQuery)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, (0, makeRawQuery_1.default)(query, variables, loadedQuery)];
                    }
                });
            });
        }
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if ((_b = initialProps.redirect) === null || _b === void 0 ? void 0 : _b.destination) {
                        ...
                        (0, redirect_1.default)(context, destination, permanent);
                        return [2 /*return*/, {}];
                    }
